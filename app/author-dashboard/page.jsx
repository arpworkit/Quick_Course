    ...
    <div className="author-dashboard">
      ...
      <main className="dashboard-main">
        ...
        <div className="welcome-section">
          ...
          <p className="welcome-subtitle">Create and manage your courses and content.</p>
        </div>
        ...
        <div className="author-content">
          <div className="dashboard-message">
            ...
            <p>This is the Author dashboard. Here you can create and manage your courses.</p>
            <p>Author dashboard functionality is coming soon...</p>
          </div>
        </div>
      </main>
    </div>
